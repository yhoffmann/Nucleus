...
{
    NucleusParameters get (uint atomic_num)
    {
        // from source [1] and [2]
        static const NucleusParameters params[] =
        { // R,     a,      w               Symbol  A           index
            {1.0,   0.0001, 0.0},       //  p       1           0       // a small to speed up the "sampling", the value itself does not mean anything
